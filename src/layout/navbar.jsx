...
export const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 transition-all duration-700 ${isScrolled ? "glass_strong py-4" : "bg-transparent py-5"
        } z-50`}
    >
      <nav className="container mx-auto px-6 flex items-center justify-between">
        ...
        <button
          className={`md:hidden p-2 text-[var(--color-foreground)] hover:cursor-pointer transition-transform duration-200 ease-out ${isMobileMenuOpen ? "rotate-90" : "rotate-0"
            }`}
      ...
      <div
        className={`md:hidden glass_strong origin-top transform transition-all duration-300 ease-out overflow-hidden ${isMobileMenuOpen
