...
const highlights = [
  {
    ...
    description:
      "Building responsive interfaces with clean structure and practical motion.",
  },
  {
    Icon: FaFigma,
    title: "UI/UX Design",
    description:
      "Designing clear user flows, polished layouts, and easier decision-making.",
  },
  {
    Icon: DiPhotoshop,
    title: "Visual Craft",
    description:
      "Refining typography, spacing, and contrast so the interface feels intentional.",
  },
  {
    Icon: FaCode,
    title: "Learning Mindset",
    description:
      "Always learning, iterating, and trying not to let the browser win.",
  },
];
          ...
          <div className="space-y-8 max-w-2xl">
            ...
            <div className="space-y-4 text-[var(--color-muted-foreground)] animate-fade-in animation-delay-200 leading-relaxed">
              ...
              <p>
                ...
                spacing, hierarchy, and clarity, because good UI should feel
                obvious without looking boring.
              </p>
              <p>
                My goal is simple: make experiences that are useful first,
                attractive second, and memorable just enough that people do not
                immediately forget where they clicked.
              </p>
            </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-6 mt-6">
          <div className="glass_strong rounded-2xl p-8 border border-[var(--color-border)]/60 shadow-[0_18px_50px_rgba(15,20,32,0.12)] animate-fade-in animation-delay-400 min-h-[220px]">
            ...
            <p className="text-md italic text-[var(--color-foreground)] leading-relaxed">
              "Build interfaces so clean and thoughtful, they anticipate what
              you need before you ask. Make the web feel less like software,
          ...
          <div className="glass_strong rounded-2xl p-8 border border-[var(--color-border)]/60 shadow-[0_18px_50px_rgba(15,20,32,0.12)] animate-fade-in animation-delay-600 min-h-[220px]">
            ...
            <p className="text-md italic text-[var(--color-foreground)] leading-relaxed">
              "A web where good design is so invisible, users forget they're
              clicking—they're just living."
            </p>
          </div>
        </div>
