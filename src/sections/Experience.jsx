...
const experience = [
  {
    ...
    company: "Concentrix Philippines - Eton Centris",
    description:
  ...
  },
  {
    ...
    description:
      "I collaborated directly with clients to design and deliver visually appealing print apparel, digital assets, and website layouts under tight deadlines.",
    toolsntechnologies: [
      "Adobe Photoshop",
      "Adobe Illustrator",
      "MainTop DTP",
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[var(--color-muted-foreground)] animate-fade-in animation-delay-200">
            A timeline of my professional journey, transitioning from a graphic
            artist and IT support intern into a passionate web developer focused
            on UI/UX design.
          </p>
        </div>
          ...
          <div className="space-y-12">
            {experience.map((exp, idx) => (
              ...
              >
                ...
                <div className="absolute left-0 md:left-1/2 top-0 w-4 h-4 bg-[var(--color-primary)] rounded-full -translate-x-1/2 ring-1 ring-background z-10">
                  {exp.current && (
                ...
                >
                  ...
                  >
                    <span className="text-sm text-[var(--color-primary)] font-medium block mb-4">
                      {" "}
                      <FiCalendar className="w-4 h-4 inline-block mr-2 justify-align text-[var(--color-primary)]" />
                      {exp.period}
                    </span>
                    ...
                    >
                      ...
                      <div className="w-[4.5rem] h-[4.5rem] shrink-0 glass p-1 rounded-full border border-[var(--color-primary)]/30">
                        <img
                          src={exp.logo}
